            ...
            <Card>
              <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  >
                    {service.isOnline ? 'Apply Online' : 'Visit Office'}
                  </Button>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">support@psshirala.gov.in</div>
                  </div>
                  <div>
      ...
      >
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-4">
            Online application for this service will be available soon. 
            Please visit the office for now.
          </p>
